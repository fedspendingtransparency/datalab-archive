...
(function init(){
    const config = {
        ...
        accessibilityAttrs : {
            default: {
                title: `${Mapping.current_fy.value} Federal Revenue`,
                desc: `The image illustrates federal revenue in ${Mapping.current_fy.value} using dots, and each dot is equal to ${Mapping.dot_represents.value}. There are ${Mapping.dot_number_revenue.value}dots.`
            },
            gdp : {
                title: `${Mapping.current_fy.value} Federal Revenue and GDP`,
            ...
            spending : {
                title: `${Mapping.current_fy.value} Federal Revenue and Spending`,
