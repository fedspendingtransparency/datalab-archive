...
function drawBars(data) {
  var transitionDuration = 1000,
      ...
      keys = chartedData;
  var bars = group.selectAll('rect').data(keys).enter().append('rect').attr('width', scales.x(0)).attr('height', dimensions.barHeight).attr('x', 0).attr('y', function (d, i) {
...
function placeCountryLabels() {
  ...
  setTimeout(function () {
    countryLabels.enter().append('text').attr('transform', function (d, i) {
      ...
      return d.country;
    }).attr('y', dimensions.rowHeight / 2 + dimensions.barHeight / 2).attr('transform', function (d, i) {
      return (0, _utils.translator)(0, i * dimensions.rowHeight);
...
function placeGdpFigures() {
  ...
  setTimeout(function () {
    gdpText.enter().append('text').attr('transform', function (d, i) {
      ...
      return (0, _utils.fractionToPercent)(d.receipts_gdp);
...
function placeLegends() {
  ...
  containers.legends.append('text').text('Federal Income as').attr('text-anchor', 'middle').attr('x', dimensions.chartWidth - dimensions.gdpColumnWidth / 2).attr('y', 26).attr('font-size', 12).append('tspan').text('Percent of GDP').attr('dy', 12).attr('x', dimensions.chartWidth - dimensions.gdpColumnWidth / 2);
}
...
function rescale() {
  ...
  containers.data.selectAll('g.bar-group').each(function (data) {
    var group = d3.select(this),
        keys = chartedData.map(function (d) {
      return d.key;
    }).sort(),
...
function placeHorizontalStripes(dataLength, dimensions) {
  var stripes;
  var chartWidth = dimensions && dimensions.chartWidth ? dimensions.chartWidth : 1200;
  ...
  }).attr('x2', chartWidth).attr('y2', function (d) {
    return d * dimensions.rowHeight;
