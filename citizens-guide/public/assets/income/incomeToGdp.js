...
function addLegend() {
  ...
  legendBox.attr('transform', (0, _utils.translator)(0, 70));
}
...
function zoomOutDots() {
  ...
  dotContainer.transition().duration(zoomDuration).attr('transform', (0, _utils.translator)(92, 70) + ' scale(0.5)').on('end', animationNext).ease();
}
