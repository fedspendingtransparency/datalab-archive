...
function enterDonut() {
  ...
  donutGroup.attr('transform', 'scale(1.5) ' + (0, _utils.translator)(400, 0)).attr('opacity', 0);
...
var _infoBox = __webpack_require__(/*! ../../infoBox */ "./src/infoBox.js");

var _revealHwcta = __webpack_require__(/*! ../reveal-hwcta */ "./src/income/reveal-hwcta.js");
...
function buildHeader() {
  ...
  text.append('tspan').text('U.S. Government Income').style('font-weight', '600').attr('y', 20).attr('x', 600).attr('transform', 'translate(0, 20)');
...
function buildLegend() {
  ...
  g.append('image').attr('height', 16).attr('width', 20).attr('x', 122).attr('y', -14).attr('opacity', 0).attr('data-box-id', 'billion-dollars').attr('xlink:href', '/assets/cg/icons/anecdote.svg').attr('style', 'cursor:pointer').on('click', _infoBox.triggerInfoBox).transition().delay(duration * 0.7).duration(duration / 2).attr('opacity', 1).ease();
}
...
__webpack_require__(/*! ../../infoBox */ "./src/infoBox.js");
...
exports.revealHwcta = revealHwcta;
...
exports.triggerInfoBox = triggerInfoBox;
