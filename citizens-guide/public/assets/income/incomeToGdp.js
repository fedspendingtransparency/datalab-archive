...
function buildLegend() {
  ...
  g.append('image').attr('height', 16).attr('width', 20).attr('x', 122).attr('y', -14).attr('opacity', 0).attr('data-box-id', 'billion-dollars').attr('xlink:href', '../assets/icons/anecdote.svg').attr('style', 'cursor:pointer').on('click', _infoBox.triggerInfoBox).transition().delay(duration * 0.7).duration(duration / 2).attr('opacity', 1).ease();
}
