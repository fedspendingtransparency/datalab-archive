...
function addLegend() {
  ...
  legendBox.attr('transform', (0, _utils.translator)(0, 60));
}
...
function zoomOutDots() {
  ...
  dotContainer.transition().duration(zoomDuration).attr('transform', (0, _utils.translator)(92, 60) + ' scale(0.4)').on('end', animationNext).ease();
}
