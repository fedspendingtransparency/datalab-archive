...
// module
exports.push([module.i, "#donut-row {\n  display: flex; }\n\n#donut-row-text {\n  padding-left: 1rem; }\n\n#donut-placeholder {\n  float: left; }\n\n#viz {\n  display: inline-block; }\n\n#continue-1, #continue-2 {\n  display: flex;\n  justify-content: center; }\n\n.fact-box--out-left {\n  margin-top: -1000px; }\n", ""]);
...
function createDonut(container, percent, diameter, fillColor) {
  ...
  g.append('text').text((0, _utils.fractionToPercent)(percent)).attr('font-size', diameter / 4).attr('text-anchor', 'middle').attr('font-weight', 'bold').attr('y', diameter * 0.08);
}
