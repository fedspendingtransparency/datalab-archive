...
(0, _tourButton.tourButton)(buttonContainer, 'gdp.html', 'Income and GDP');
...
function tourButton(elem, url, linkText) {
  var anchor = d3.select(elem).append('a').attr('href', url + '?tour').classed('tour-link', true);
  anchor.append('svg').attr('width', 14).attr('height', 20).attr('transform', 'scale(1.4)').append('path').attr('stroke', 'none').attr('fill', 'white').attr('d', dString());
  anchor.append('div').text('Continue').classed('tour-link__continue', true);
  anchor.append('div').text('to ' + linkText).classed('tour-link__link-text', true);
}
