...
d3.json('../../../data-lab-data/contracts-over-time/panel9.json', (data) => {
  ...
  function brushed() {
    ...
    d3.selectAll("#svg-4 > g > g:nth-child(1) > g").remove();
    DrawLines(0);
    DrawVerticalLines(0);
  ...
  $(".part2control-group2 > div > label > input:checkbox").on("click", (e) => {
    const checkedVals = $('.box2:checkbox:checked').map(function () {
        return this.value;
    }).get();

    if(checkedVals.length===2){
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","1px");
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","1px");
    }else if(checkedVals[0]==="resolution"){
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","1px");
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","0px");
    }else if(checkedVals[0]==="budget"){
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","1px");
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","0px");
    }else{
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","0px");
        d3.selectAll("#svg-4 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","0px");
    }
