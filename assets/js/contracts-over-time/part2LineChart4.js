...
d3.json('../../../data-lab-data/contracts-over-time/panel10.json', (data) => {
  ...
  function brushed() {
    ...
    d3.selectAll("#svg-6 > g > g:nth-child(1) > g").remove();
    DrawLines(0);
    DrawVerticalLines(0);
  ...
  var legend = d3.select('.part2legend4').selectAll("legends")
    .data(legendVals)
    .enter().append("div")
    .attr("class","legends");
  ...
  $(".part2control-group4 > div > label > input:checkbox").on("click", (e) => {
    var checkedVals = [];
     checkedVals = $('.box4:checkbox:checked').map(function () {
        return this.value;
    }).get();

    if(checkedVals.length===2){
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","1px");
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","1px");
    }else if(checkedVals[0]==="resolution"){
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","1px");
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","0px");
    }else if(checkedVals[0]==="budget"){
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","1px");
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","0px");
    }else{
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(3) > line").style("stroke-width","0px");
        d3.selectAll("#svg-6 > g > g:nth-child(1) > g:nth-child(2) > line").style("stroke-width","0px");
    }
  ...
  p.on("mouseover",(d) => {
    if (d === "Research and Development"){
      d3.selectAll("#svg-6 > g > g > g.line-paths > path").style("stroke-width","0px");
      d3.select("#svg-6 > g > g > g.line-paths > path:nth-child(1)").style("stroke-width","1px");
      d3.selectAll("#svg-6 > g > g.context > g.line-paths > path").style("stroke-width","0px");
      d3.select("#svg-6 > g > g.context > g.line-paths > path:nth-child(1)").style("stroke-width","1px");
    }else if (d === "Weapons & Ammunition"){
      d3.selectAll("#svg-6 > g > g > g.line-paths > path").style("stroke-width","0px");
      d3.select("#svg-6 > g > g > g.line-paths > path:nth-child(2)").style("stroke-width","1px");
      d3.selectAll("#svg-6 > g > g.context > g.line-paths > path").style("stroke-width","0px");
      d3.select("#svg-6 > g > g.context > g.line-paths > path:nth-child(2)").style("stroke-width","1px");
    }
  })
  .on("mouseout",() => d3.selectAll("#svg-6 > g > g > g.line-paths > path").style("stroke-width","1px"));
});
